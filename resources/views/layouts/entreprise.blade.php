...
<html lang="en">
    <head>
        ...
        <title>Entreprise - ISET Bizerte</title>
    ...
    <body id="page-top">
            ...
            <a class="navbar-brand js-scroll-trigger" style="color:white;letter-spacing:3px" href="#page-top"><img src="{{URL::asset('employeImages/navbar-logo.png')}}" height="50" alt="logo" />ISET Bizerte</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ route('entrepriseStages.index') }}">About</a></li>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Bienvenu dans la partie Entreprise de ce site</div>
                <div class="masthead-heading text-uppercase">Cette partie gére les entreprises</div>
