...
<div class="row">
    <div class="col">
        <div class="form-group">
            ...
            <input type="text" name="nom_entre" value="{{ $entrepriseStages->nom_societe ?? old('nom_entre') }}" id="nom_entre" class="form-control @error('nom_entre') is-invalid @enderror" placeholder="Nom d'entreprise de stage">
    ...
    <div class="col">
        <div class="form-group">
            ...
            <input type="text" name="duree_stage" value="{{ $entrepriseStages->duree ?? old('duree_stage') }}" id="duree_stage" class="form-control @error('duree_stage') is-invalid @enderror" placeholder="Duree de stage">
...
<div class="row">
    ...
    <div class="col">
        <div class="form-group">
            ...
            <input type="coordoonnes" name="coordoonees" value="{{ $entrepriseStages->coordoonees ?? old('coordoonees') }}" id="coordoonees" class="form-control @error('coordoonees') is-invalid @enderror" placeholder="Coordonnee de entreprise">
    ...
    <div class="col" id="sujetField" style="display:none">
        <div class="form-group">
            ...
            <input type="text" name="sujet" value="{{ $entrepriseStages->sujet ?? old('sujet') }}" id="sujet" class="form-control @error('sujet') is-invalid @enderror" placeholder="Sujet PFE">
