...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Bienvenu dans la partie encadrant de ce site</div>
                <div class="masthead-heading text-uppercase">Cette partie gère les encadrants</div>
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Listes des Encadrants</h2>
                        ...
                        <div class="col-lg-4">
                            <div class="team-member">
                               <h4>{{ $enc['first_name'] }} {{ $enc['last_name'] }}</h4>
                                <p class="text-muted">{{ $enc['specialty'] }}</p>
                                <p class="text-muted">{{ $enc['email'] }}</p>
